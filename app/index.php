...
<head>
  ...
  <title>ระบบบริหารจัดการเนื้อหาบนโทรศัพท์</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="#/pages/folder-level1-user" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>W</b>FHT</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">WFHT</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a id="clickProfile" style="cursor: pointer;" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs titleFullname" id=''></span>
            </a>
    ...
    <section class="sidebar">
      <!-- Sidebar user panel -->
       ...
       <div class="image1" style="text-align: center;">
          ...
          <p style="color: white;">ระบบบริหารจัดการ<br>เนื้อหาบนโทรศัพท์</p>
        </div>
      ...
      <ul class="sidebar-menu mainMenuAdminLeftArea" data-widget="tree">
        ...
        <li class="menuDisplay mainMenu adminMenu">
          <a href="#/pages/folder-level1-user" id="folder_level1_user_main_menu">
        ...
        <li  class="menuDisplay mainMenu adminMenu">
          <a href="#/pages/user-management" id="user_management_main_menu">
            <i class="fa fa-users"></i> <span>จัดการผู้ใช้งาน</span>
        ...
        <li class="menuDisplay mainMenu adminMenu">
          <a href="#/pages/user-group" id="user_group_main_menu">
            <i class="glyphicon glyphicon-lock"></i> <span>สิทธิ์การใช้งาน</span>
          </a> 
        </li>
      ...
      -->
        ...
        <li class="menuDisplay mainMenu adminMenu">
          <a href="#/pages/folder-cate" id="folder_cate_main_menu">
            <i class="fa fa-fw fa-folder-open-o"></i> <span>จัดการหมวดแฟ้ม(Level1)</span>
